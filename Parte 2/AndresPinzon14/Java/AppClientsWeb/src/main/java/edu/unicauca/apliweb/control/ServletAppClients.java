...
import edu.unicauca.apliweb.persistence.entity.Clients;
import edu.unicauca.apliweb.persistence.jpa.ClientsJpaController;
...
public class ServletAppClients extends HttpServlet {
    ...
    private ClientsJpaController clientsJPA;
    private final static String PU = "edu.unicauca.apliweb_AppClientsWeb_war_1.0-SNAPSHOTPU";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletAppClients</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletAppClients at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public void init() throws ServletException {
        ...
        clientsJPA = new ClientsJpaController(emf);
        ...
        List<Clients> listaClientes = clientsJPA.findClientsEntities();
        //imprimimos los clientes en consola
        for (Clients cliente : listaClientes) {
            System.out.println("Nombre " + cliente.getName() + " correo " + cliente.getEmail());
        }
    }
